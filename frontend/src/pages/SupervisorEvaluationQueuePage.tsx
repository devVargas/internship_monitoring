...
export default function SupervisorEvaluationQueuePage() {
  const { documents, isLoading, error } = useSupervisorEvaluationQueue()
          ...
          {!isLoading && !error && documents.length === 0 && (
            <div className="p-10 text-center">
              ...
              <p className="mt-1 text-sm text-neutral-500">
                Os alunos que aguardam uma nova avaliação aparecerão aqui. Avaliações já geradas ficam no Histórico de documentos para assinatura.
              </p>
            </div>
          )}
